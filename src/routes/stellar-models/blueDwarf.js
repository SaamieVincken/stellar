...
export function initializeBrightBlueModel() {
    ...
    const sphereRadius = 2.0; // Adjust the radius as needed
    ...
    glowSphere.scale.set(0.95, 0.95, 0.95); // Make it smaller
    ...
    const initialScale = 0.95; // Adjust the initial scale
